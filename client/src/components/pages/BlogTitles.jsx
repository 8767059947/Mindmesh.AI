...
function BlogTitles() {
  ...
  // 🟡 Copy to Clipboard ka function
  const copyToClipboard = () => {
    navigator.clipboard.writeText(content);
    toast.success("Copied to clipboard!");
  };

  // 🔵 Submit handler jab user title generate kare
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
        ...
        {/* ✅ Copy Button agar content available hai */}
        {content && (
          <div className="flex justify-end mt-2">
            <button
              onClick={copyToClipboard}
              className="flex items-center gap-2 text-xs px-3 py-1 rounded-md border border-purple-500 text-purple-600 hover:bg-purple-50 transition"
            >
